...
$(function () {
    ...
    $(document).ready($.ajax({
        ...
        success: function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                data3 = JSON.parse(data2);
                data3.url = '/manage/category/'+data1[i].pk+'/';
    ...
    $(document).on('click','.del',function() {
        ...
        console.log(index);
        var category = $('h3').eq(index).text();
        console.log(category);
        $.ajax({
            url: '/manage/category/delete_single/',
            type: 'post',
            data: {
                category: category
            },
